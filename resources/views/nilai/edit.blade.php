...
<form class="form-horizontal" action="/nilai/{{$nilai->id}}"  method="post">
	...
	<div>
	<label class="col-md-4"> Nilai Hasil</label>
	<input class="form-control col-md-8" name="hasil" value="{{ $nilai->hasil}}">
	</div>
	<div>
	<label class="col-md-4"> Nilai Pembimbing</label>
	<input class="form-control col-md-8" name="nilai_pembimbing" value="{{ $nilai->nilai_pembimbing}}">
	</div>
	<div>
	<label class="col-md-4"> Nilai Penguji</label>
	<input class="form-control col-md-8" name="nilai_penguji" value="{{ $nilai->nilai_penguji}}">
	</div>
	<div>

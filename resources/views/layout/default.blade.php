              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-calendar"></i>Jadwal <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{route('jadwal')}}">Data Jadwal PKL</a></li>
                      <li><a href="{{route('jadwal.create')}}">Tambah Jadwal </a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-suitcase"></i>Bimbingan<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{route('bimbingan')}}">Data bimbingan</a></li>
                      <li><a href="{{route('bimbingan.create')}}">Tambah Data bimbingan</a></li>       
                    </ul>
                  </li>
                  ...
                  <li><a><i class="fa fa-suitcase"></i>Nilai<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{route('nilai')}}">Data Nilai</a></li>
                      <li><a href="{{route('nilai.create')}}"> Tambah Data Nilai</a></li>       
                    </ul>
                  </li>
                </ul>
              </div>

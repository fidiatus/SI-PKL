...
<form class="" action="/mahasiswa"  method="post">
	...
	<p> Status Sekolah : 
	<input type="text" name="status_sekolah" value="" placeholder="status_sekolah">
	...
	<p> Verify :
	<input type="text" name="verify" value="" placeholder="verify">
	{{ ($errors->has('verify'))? $errors->first('verify'): ''}} </p>
	<div>
	</div>
	<br/>

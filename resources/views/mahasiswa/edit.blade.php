...
<form class="form-horizontal" action="/mahasiswa/{{$mahasiswa->id}}"  method="post">
	...
	<input class="form-control col-md-8" name="password" value="{{ $mahasiswa->password }}">
	</div>
	<div>
	...
	<div>
	<label class="col-md-4"> Verify</label>
	<input class="form-control col-md-8" name="verivy" value="{{ $mahasiswa->verify}}">
	</div>
